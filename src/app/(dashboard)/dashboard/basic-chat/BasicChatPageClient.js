            ...
            >
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="material-symbols-outlined text-[18px] text-[var(--color-text-muted)]">expand_more</span>
                </div>
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-start justify-between gap-3">
                                ...
                                {isActive ? <span className="material-symbols-outlined text-[18px] text-[var(--color-info)]">check_circle</span> : null}
                              </div>
                            </button>
                          );
                        })}
